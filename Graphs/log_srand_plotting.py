...
#For Btree(GitHub)
#Load Time
x_bt51 = np.array([135536,134872,135100,134744,134805])
x_bt61 = np.array([1.59688e+06,1.58522e+06,1.58836e+06,1.61125e+06,1.58617e+06])
x_bt71 = np.array([2.1306e+07,2.13356e+07,2.13155e+07,2.12774e+07,2.13162e+07])
x_bt81 = np.array([2.64982e+08,2.65615e+08,2.66351e+08,2.64871e+08,2.65728e+08,])
x_bt91 = np.array([3.2038e+09,3.21902e+09,3.20239e+09,3.21216e+09,3.18822e+09])
x_bt = np.sum(x_bt91)/5
print x_bt
plt.axvline(x=x_bt/1000000,color = 'r',label = 'BTree')
#x_bt = (x_bt51 + x_bt61 + x_bt71 + x_bt81 + x_bt91)/1000000
#print x_bt
#Scan Time
y_bt51 = np.array([814,812,826,818,811])
y_bt61 = np.array([1089,1083,1083,1084,1085])
y_bt71 = np.array([1602,1599,1598,1618,1598])
y_bt81 = np.array([2616,2447,2462,2449,2498])
y_bt91 = np.array([3386,3511,3280,3186,3232])
y_bt_avg = np.sum(y_bt91)/5
print y_bt_avg
#y_bt = (y_bt51 + y_bt61 + y_bt71 + y_bt81 + y_bt91)/1000000000.00
#print y_bt
#plt.plot(x_bt,y_bt,label = 'BTree',color = 'm')
plt.axhline(y=y_bt_avg/1000000000.00,color = 'r',label = 'BTree')



#Unorderedmap Load Time
x_um5 = np.array([81172,78759,76443,74916,43340])
x_um6 = np.array([587306,599771,602310,612342,610137])
x_um7 = np.array([1.01056e+07,1.02262e+07,1.02325e+07,1.01654e+07,1.01912e+07])
x_um8 = np.array([1.07147e+08,1.09265e+08,1.0792e+08,1.07375e+08,1.07262e+08])
x_um9 = np.array([1.32872e+09,1.33366e+09,1.3367e+09,1.33658e+09,1.34852e+09])
#x_um = (x_um5 + x_um6 + x_um7 + x_um8 + x_um9)/1000000
x_um = np.sum(x_um9)/5
plt.axvline(x=x_um/1000000,color = 'm',label = 'UM')
#ScanTime
y_um5 = np.array([376,246,262,248,172])
y_um6 = np.array([389,388,389,390,389])
y_um7 = np.array([379,375,370,371,375])
y_um8 = np.array([585,674,589,606,603])
y_um9 = np.array([737,788,935,839,949])
#y_um = (y_um5 + y_um6 + y_um7 + y_um8 + y_um9)/1000000000.00
y_um = np.sum(y_um9)/5
plt.axhline(y=y_um/1000000000.00,color = 'm',label = 'UM')

#plt.plot(x_um,y_um,label = 'UnorderedMap',color = 'm')
