...
font = {'family' : 'Times New Roman',
        'size'   : 8}
f.savefig("/Users/darshanabalakrishnan/Desktop/JITD-ICDE-2018/CrackThresholdVsScanTime(HeavyHitter).pdf",dpi = '300', bbox_inches='tight', format = 'pdf',transparent= 'true')